      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-950 transition-colors">
         <div className="max-w-screen-xl mx-auto px-4">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
             <Link href="/dashboard/support" className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-kt-blue dark:hover:border-kt-blue transition group">
           ...
           <div className="max-w-3xl mx-auto">
             ...
             <div className="mt-12 bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-8 border border-blue-100 dark:border-blue-800/50 text-center flex flex-col items-center">
                ...
                <Link href="/dashboard/support" className="bg-kt-blue hover:bg-blue-600 text-white font-semibold py-3 px-8 rounded-lg shadow-md transition-colors">
